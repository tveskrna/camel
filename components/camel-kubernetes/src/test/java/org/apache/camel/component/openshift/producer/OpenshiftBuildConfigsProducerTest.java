...
public class OpenshiftBuildConfigsProducerTest extends KubernetesTestSupport {
    ...
    public void listTest() throws Exception {
        server.expect().withPath("/apis/build.openshift.io/v1/buildconfigs").andReturn(200, new BuildConfigListBuilder().addNewItem().and().addNewItem().and().build()).once();
    ...
    public void listByLabelsTest() throws Exception {
        server.expect().withPath("/apis/build.openshift.io/v1/buildconfigs?labelSelector=" + toUrlEncoded("key1=value1,key2=value2"))
