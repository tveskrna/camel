	...
	protected RouteBuilder createRouteBuilder() throws Exception {
		return new RouteBuilder() {
			...
			public void configure() throws Exception {
				from("direct:startWithEndpointSSL").to("restlet:https://localhost:9000/?restletMethod=post&sslContextParameters=#mySSLContextParameters");

				from("restlet:https://localhost:9000/?restletMethods=post&sslContextParameters=#mySSLContextParameters")
