...
/**
 * Basic testing to ensure that the SQSClientStandardImpl class is returning a standard client that is
 * capable of encryption given certain parameters. 
 */
public class StandardAWSSQSClientImplTest {

    @Test
    public void standardAWSS3ClientImplNoEncryption() {
        SQSClientStandardImpl standardAWSSQSClient = new SQSClientStandardImpl(getSQSConfiguration());
        AmazonSQS sqsClient = standardAWSSQSClient.getSQSClient();
