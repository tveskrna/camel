...
*Available as of Camel version 3.8*
...
The Paho MQTT 5 component supports 4 options, which are listed below.
...
| *connectionOptions* (advanced) | Client connection options |  | MqttConnectionOptions
...
| *clientId* (common) | MQTT client identifier. |  | String
| *connectionOptions* (common) | Client connection options |  | MqttConnectionOptions
...
| *persistence* (common) | Client persistence to be used - memory or file. | MEMORY | PahoMqtt5Persistence
