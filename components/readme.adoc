...
// components: START
Number of Components: 306 in 207 JAR artifacts (20 deprecated)
...
`irc:hostname:port/channel` | 1.1 | The irc component implements an IRC (Internet Relay Chat) transport.
...
`jira:type` | 2.21 | The jira component interacts with the JIRA issue tracker.
...
| link:camel-rest-openapi/src/main/docs/rest-openapi-component.adoc[REST OpenApi] (camel-rest-openapi) +
...
// dataformats: START
Number of Data Formats: 49 in 39 JAR artifacts (4 deprecated)
...
// others: START
Number of Miscellaneous Components: 46 in 46 JAR artifacts (13 deprecated)
...
| link:camel-openapi-java/src/main/docs/openapi-java.adoc[Openapi Java] (camel-openapi-java) | 3.1 | Rest-dsl support for using openapi doc
...
| link:camel-undertow-spring-security/src/main/docs/undertow-spring-security.adoc[Undertow Spring Security] (camel-undertow-spring-security) |  | Camel Components
